...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txtDOB.setOnClickListener(){
            ...
            val dpd = DatePickerDialog(this,
                ...
                val minSavings = getSavings(theAge)
                val maxTransferAmt = minSavings * 0.30

                txtAge.setText(theAge.toString())
                txtMinSavings.setText(minSavings.toString())
                txtMaxTransfer.setText(maxTransferAmt.toString())
    ...
    fun getSavings(theAge:Int):Double{
